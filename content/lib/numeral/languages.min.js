...
function(){var a={delimiters:{thousands:" ",decimal:","},abbreviations:{thousand:"тис.",million:"млн",billion:"млрд",trillion:"блн"},ordinal:function(){return""},currency:{symbol:"₴"}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("uk",a)}();
...
/*!
 * numeral.js language configuration
 * language : Latvian (lt) – generally useful in Latvian
 * author : Valdas Cesaitis
 */
!function(){var a={delimiters:{thousands:' ',decimal:','},abbreviations:{thousand: 'tūkst',million: 'mln.',billion: 'mlrd.',trillion: 'trln.'},ordinal:function(number){return number===1?'vien.': 'daug.';},currency:{symbol: '€'}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("lt",a)}();/*!
 * numeral.js language configuration
 * language : China (zh) – generally useful in
 * author :
 */
!function(){var a={delimiters:{thousands:" ",decimal:","},abbreviations:{thousand:"k",million:"m",billion:"b",trillion:"t"},ordinal:function(){return"."},currency:{symbol:"€"}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("zh",a)}();/*!
 * numeral.js language configuration
 * language :  (hy) – generally useful in
 * author :
 */
!function(){var a={delimiters:{thousands:" ",decimal:","},abbreviations:{thousand:"k",million:"m",billion:"b",trillion:"t"},ordinal:function(){return"."},currency:{symbol:"€"}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("hy",a)}();/*!
 * numeral.js language configuration
 * language :  (ka) – generally useful in
 * author :
 */
!function(){var a={delimiters:{thousands:" ",decimal:","},abbreviations:{thousand:"k",million:"m",billion:"b",trillion:"t"},ordinal:function(){return"."},currency:{symbol:"€"}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("ka",a)}();
!function(){var a={delimiters:{thousands:" ",decimal:","},abbreviations:{thousand:"هزار",million:"میلیون",billion:"میلیارد",trillion:"ریلیون"},ordinal:function(){return"."},currency:{symbol:"IR"}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("fa",a)}();
!function(){var a={delimiters:{thousands:" ",decimal:","},abbreviations:{thousand:"мың.",million:"млн",billion:"млрд",trillion:"трлн"},ordinal:function(){return"."},currency:{symbol:"теңге."}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("kk",a)}();
!function(){var a={delimiters:{thousands:" ",decimal:","},abbreviations:{thousand:"dz.",million:"mln.",billion:"mlrd",trillion:"bln"},ordinal:function(){return"."},currency:{symbol:"rur."}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("nl",a)}();